...
public class GaodUtil {
	 ...
	 */
	public String addTableDateOnLoctypeBylocation(String name,Double _locationLongitude,Double _localtionlatitude,Map<String,String> map){
		String url="http://yuntuapi.amap.com/datamanage/data/create";
		int loctype=1;//坐标定位
		String _location=_locationLongitude+","+_localtionlatitude;
		String param="loctype="+loctype+"&key="+config.getAppKey()+"&tableid="+config.getTableid();
	 ...
	 */
	public String addTableDateOnLoctypeByAddress(String name,String address,Map<String,Object> map){
		String url="http://yuntuapi.amap.com/datamanage/data/create";
		int loctype=2;//坐标定位
		String param="loctype="+loctype+"&key="+config.getAppKey()+"&tableid="+config.getTableid();
		StringBuffer data=new StringBuffer();
	 ...
	 */
	public String createTable(String name,String sig){
		String url="http://yuntuapi.amap.com/datamanage/table/create";
		String param="key="+config.getAppKey()+"&name="+name+"&sig="+(sig==null?"":sig);
	...
	public String deleteData(String id){
		...
		String arg="ids="+id+"&key="+config.getAppKey()+"&tableid="+config.getTableid();
	 ...
	 * @return
	 */
	public String deleteData(Set<String> ids){
		String url="http://yuntuapi.amap.com/datamanage/data/delete";
		String arg="key="+config.getAppKey()+"&tableid="+config.getTableid();
	 ...
	 * @return
	 */
	public String updateTableData(String id,Map<String, Object> map){
		String url="http://yuntuapi.amap.com/datamanage/data/update";
		String param="key="+config.getAppKey()+"&tableid="+config.getTableid();
